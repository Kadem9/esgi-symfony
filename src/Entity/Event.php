...
class Event
{
    ...
    public function isGenerateImageByFixture(): ?bool
    {
        return $this->generateImageByFixture;
    }

    public function setGenerateImageByFixture(bool $generateImageByFixture): static
    {
